...
((_ref_i<_ref_allActors.size())); (_ref_i++)) {
				{
					...
					if (((temp0=_ref_actor, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 32"), temp0)->_ref_id==_ref__id)) {
						{
							return _ref_actor;
...
, TIME_TYPE executionTime, TIME_TYPE deadline){
	...
	void BaseActor::setNow(TIME_TYPE now) {
		...
		{
_ref_now += 1;
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 40"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
