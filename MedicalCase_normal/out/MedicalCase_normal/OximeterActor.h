...
#ifndef __OXIMETER_ACTOR_H__
#define __OXIMETER_ACTOR_H__
...
public:
    OximeterActor(byte myID, char* myName, int maxQueueLength, int maxParamLength, vector<AbstractActor*>& rebecsRef
		#ifdef DEBUG_LEVEL_2 
			, ostream &out
		#endif
    ...
    void unmarshalVariablesFromArray(byte * array);
		...
		long constructorOximeter(byte creatorID
	        ,
    		int
	         _ref__id
		);
