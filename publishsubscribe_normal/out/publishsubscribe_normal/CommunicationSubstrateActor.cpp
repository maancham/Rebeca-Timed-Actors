...
, TIME_TYPE executionTime, TIME_TYPE deadline){
	...
	void CommunicationSubstrateActor::setNow(TIME_TYPE now) {
...

		{
			...
			(temp0=_ref_si, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 80"), temp0)->_timed_msg_publish(myID, (_ref_Lm+_ref_csDelay), (_ref_life-_ref_csDelay), _ref_csDelay + _ref_now, MAX_TIME);
		}
		if (__tNumber & 1) {
