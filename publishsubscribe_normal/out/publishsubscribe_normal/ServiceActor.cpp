...
_ref_now += _ref_consumeDelay;
			...
			(temp0=_ref_si, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 146"), temp0)->_timed_msg_consumed(myID, (_ref_Lm+_ref_consumeDelay), _ref_now, MAX_TIME);
		}
		if (__tNumber & 1) {
		...
		{
_ref_now += 1;
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 150"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 152"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 153"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 154"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
