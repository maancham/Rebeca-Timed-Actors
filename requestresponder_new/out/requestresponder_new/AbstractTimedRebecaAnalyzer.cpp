#include "AbstractTimedRebecaAnalyzer.h"
		...
		#define _ref_rr (dynamic_cast<RequestRequesterActor*>(rebecs[1]))
		#define _ref_cs (dynamic_cast<CommunicationSubstrateActor*>(rebecs[2]))
		#define _ref_ri (dynamic_cast<ResponderInvokerActor*>(rebecs[3]))
...
void AbstractTimedRebecaAnalyzer::instantiationPart() {
	...
	byte maxRebecID = 0;
    	...
    	RequestRequesterActor* _ref_rr = new RequestRequesterActor(maxRebecID++, "rr", 20, 8, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 205
    	...
    	ResponderInvokerActor* _ref_ri = new ResponderInvokerActor(maxRebecID++, "ri", 20, 8, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 205
