	...
	)
{
	...
	messageNames[0] = (char*)"Empty";
			...
			messagePriorities[3] = std::numeric_limits<int>::max();
       		 messageNames[4] = (char*)"FASTREQUESTFAILURE";
...
long ClientActor::methodSelectorAndExecutor() {
    ...
    switch (messageQueue[0]) {
            ...
            case FASTREQUESTFAILURE:
                {
                    int i = 0;
                    return msgsrvfastRequestFailure(
                    );
                }
            case TIMEOUTFAILURE:
                {
    ...
    long ClientActor::constructorClient (byte creatorId 
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 16"), temp0)->_timed_msg_request(myID, 3 + _ref_now, MAX_TIME);
		}
		shift = 0;
		queueTail = 0;
		...
		void ClientActor::_msg_request (byte senderId
  	  ){
        queueTail = 0;
		...
		void ClientActor::_msg_response (byte senderId
	        ,
    		int
	         _ref_Lm
  	  ){
		...
		void ClientActor::_msg_fastRequestFailure (byte senderId
  	  ){
        queueTail = 0;
		...
		void ClientActor::_msg_dataUnavailableFailure (byte senderId
  	  ){
        queueTail = 0;
		...
		void ClientActor::_msg_staleData (byte senderId
  	  ){
        queueTail = 0;
	...
	vector<TimeFrame>** ClientActor::getHashtableTimeExtension() {
	    ...
	    void ClientActor::_timed_msg_request (byte senderId
, TIME_TYPE executionTime, TIME_TYPE deadline){
	    _msg_request (senderId
);
	    addTimedBundles(senderId, executionTime, deadline);
		}
	    void ClientActor::_timed_msg_response (byte senderId
	        ,
    		int
	         _ref_Lm
, TIME_TYPE executionTime, TIME_TYPE deadline){
...
, TIME_TYPE executionTime, TIME_TYPE deadline){
	    ...
	    void ClientActor::_timed_msg_fastRequestFailure (byte senderId
, TIME_TYPE executionTime, TIME_TYPE deadline){
...
, TIME_TYPE executionTime, TIME_TYPE deadline){
	    ...
	    void ClientActor::_timed_msg_dataUnavailableFailure (byte senderId
, TIME_TYPE executionTime, TIME_TYPE deadline){
	    _msg_dataUnavailableFailure (senderId
);
	    addTimedBundles(senderId, executionTime, deadline);
		}
	    void ClientActor::_timed_msg_staleData (byte senderId
, TIME_TYPE executionTime, TIME_TYPE deadline){
	...
	void ClientActor::setNow(TIME_TYPE now) {
	    ...
	    long ClientActor::msgsrvrequest (
    ) {
		...
		{
			int _ref_rDelay = (__tNumber|=1, nonDetVariable0);

_ref_now += _ref_rDelay;
			(temp0=_ref_RR, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 21"), temp0)->_timed_msg_request(myID, (_ref_rDelay+3), _ref_now, MAX_TIME);
		}
		if (__tNumber & 1) {
	    ...
	    long ClientActor::msgsrvresponse (
    		int
	         _ref_Lm
    ) {
    			long arrayIndexChecker = 0;ClientActor *temp0;
...

		{
			...
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 26"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
...
_ref_now += 1;
	    ...
	    long ClientActor::msgsrvfastRequestFailure (
    ) {
    			long arrayIndexChecker = 0;ClientActor *temp0;
		shift = 1;
		#ifdef SAFE_MODE
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 33"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 34"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;

}
	    long ClientActor::msgsrvdataUnavailableFailure (
    ) {
    			long arrayIndexChecker = 0;ClientActor *temp0;
		shift = 1;
		#ifdef SAFE_MODE
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 35"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;

}
	    long ClientActor::msgsrvstaleData (
    ) {
    			long arrayIndexChecker = 0;ClientActor *temp0;
		shift = 1;
		#ifdef SAFE_MODE
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 36"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
