...
, TIME_TYPE executionTime, TIME_TYPE deadline){
	...
	void CommunicationSubstrateActor::setNow(TIME_TYPE now) {
...

		{
			...
			(temp0=_ref_RI, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 109"), temp0)->_timed_msg_request(myID, (_ref_Lm+_ref_cs1Delay), _ref_cs1Delay + _ref_now, MAX_TIME);
		}
		if (__tNumber & 1) {
...

		{
			...
			(temp0=_ref_RR, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 114"), temp0)->_timed_msg_response(myID, (_ref_Lm+_ref_cs2Delay), (_ref_life-_ref_cs2Delay), _ref_cs2Delay + _ref_now, MAX_TIME);
		}
		if (__tNumber & 1) {
			if (false){/*Dummy 'if' statement to create nested else-if easily!*/}
			else if(nonDetVariable0 == 1) {
		...
		{
			(temp0=_ref_RR, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 117"), temp0)->_timed_msg_excessLoadFailure(myID, _ref_now, MAX_TIME);
		}
		return 0;
		...
		{
			(temp0=_ref_RR, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 120"), temp0)->_timed_msg_timeOutFailure(myID, _ref_now, MAX_TIME);
		}
		return 0;
		...
		{
			(temp0=_ref_RR, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 123"), temp0)->_timed_msg_dataUnavailableFailure(myID, _ref_now, MAX_TIME);
		}
		return 0;
