#include "AbstractTimedRebecaAnalyzer.h"
		...
		#define _ref_c3 (dynamic_cast<CustomerActor*>(rebecs[4]))
		#define _ref_c4 (dynamic_cast<CustomerActor*>(rebecs[5]))
		#define _ref_c5 (dynamic_cast<CustomerActor*>(rebecs[6]))
		#define _ref_c6 (dynamic_cast<CustomerActor*>(rebecs[7]))
		#define _ref_c7 (dynamic_cast<CustomerActor*>(rebecs[8]))
...
void AbstractTimedRebecaAnalyzer::instantiationPart() {
	...
	byte maxRebecID = 0;
    	...
    	CustomerActor* _ref_c3 = new CustomerActor(maxRebecID++, "c3", 3, 0, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 12
        ...
        rebecs.push_back(_ref_c3);
        referenceToRebecs->push_back(_ref_c3);
    	CustomerActor* _ref_c4 = new CustomerActor(maxRebecID++, "c4", 3, 0, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 12
        ...
        rebecs.push_back(_ref_c4);
        referenceToRebecs->push_back(_ref_c4);
    	CustomerActor* _ref_c5 = new CustomerActor(maxRebecID++, "c5", 3, 0, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 12
        ...
        rebecs.push_back(_ref_c5);
        referenceToRebecs->push_back(_ref_c5);
    	CustomerActor* _ref_c6 = new CustomerActor(maxRebecID++, "c6", 3, 0, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 12
        ...
        rebecs.push_back(_ref_c6);
        referenceToRebecs->push_back(_ref_c6);
    	CustomerActor* _ref_c7 = new CustomerActor(maxRebecID++, "c7", 3, 0, *referenceToRebecs 
    											#ifdef DEBUG_LEVEL_2 
    											, analysisOutputStream 
    											#endif
    											, 12
        ...
        rebecs.push_back(_ref_c7);
        referenceToRebecs->push_back(_ref_c7);
 ...
 _ref_c2->known[1] = _ref_a->myID;
    	...
    	_ref_c3->known = new byte[MAX_KNOWN];
    	_ref_c3->known[0] = _ref_c3->myID;
 _ref_c3->known[1] = _ref_a->myID;

		_ref_c3->constructorCustomer(INITIAL_SENDER
	        , 3
		);
    	_ref_c4->known = new byte[MAX_KNOWN];
    	_ref_c4->known[0] = _ref_c4->myID;
 _ref_c4->known[1] = _ref_a->myID;

		_ref_c4->constructorCustomer(INITIAL_SENDER
	        , 4
		);
    	_ref_c5->known = new byte[MAX_KNOWN];
    	_ref_c5->known[0] = _ref_c5->myID;
 _ref_c5->known[1] = _ref_a->myID;

		_ref_c5->constructorCustomer(INITIAL_SENDER
	        , 5
		);
    	_ref_c6->known = new byte[MAX_KNOWN];
    	_ref_c6->known[0] = _ref_c6->myID;
 _ref_c6->known[1] = _ref_a->myID;

		_ref_c6->constructorCustomer(INITIAL_SENDER
	        , 6
		);
    	_ref_c7->known = new byte[MAX_KNOWN];
    	_ref_c7->known[0] = _ref_c7->myID;
 _ref_c7->known[1] = _ref_a->myID;

		_ref_c7->constructorCustomer(INITIAL_SENDER
	        , 7
		);
