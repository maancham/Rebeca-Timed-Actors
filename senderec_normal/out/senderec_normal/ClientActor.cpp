...
long ClientActor::methodSelectorAndExecutor() {
    ...
    long ClientActor::constructorClient (byte creatorId 
		...
		{
			(_ref_TotalLatency=0);
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 10"), temp0)->_timed_msg_send(myID, 3 + _ref_now, MAX_TIME);
		}
		shift = 0;
		queueTail = 0;
		...
		void ClientActor::_msg_send (byte senderId
  	  ){
        queueTail = 0;
	...
	vector<TimeFrame>** ClientActor::getHashtableTimeExtension() {
	    ...
	    void ClientActor::_timed_msg_send (byte senderId
...
_ref_now += _ref_clientDelay;
			(temp0=_ref_SR, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 16"), temp0)->_timed_msg_send(myID, (_ref_clientDelay+3), _ref_now, MAX_TIME);
		}
		if (__tNumber & 1) {
...

		{
			...
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 21"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
		...
		{
			(temp0=_ref_self, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 24"), temp0)->_timed_msg_busy(myID, _ref_now, MAX_TIME);
		}
		return 0;
