...
using namespace std;
	 ...
	 int _ref_START_VENTILATOR = 1;
 
	 int _ref_STOP_VENTILATOR = 0;
 
	 int _ref_START_X_RAY = 2;
 
	 int _ref_STOP_X_RAY = 3;
 
	 int _ref_FAIL = 0;
 
	 int _ref_SUCCEED = 1;
 
	 int _ref_UNAVAILABLE = 2;
...
int main(int argc, char* argv[]) {
	...
	for (list<string>::iterator it = parser.getEnvironmentVariables().begin(); it != parser.getEnvironmentVariables().end(); ++it) {
		...
		string value = envVar.substr(index + 1, envVar.length());
				...
				if (name == "N_INI")				
					try {
							_ref_N_INI = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"N_INI\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"N_INI\".-->" << endl;
					}
				...
				if (name == "L_INI")				
					try {
							_ref_L_INI = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"L_INI\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"L_INI\".-->" << endl;
					}
				...
				if (name == "N_EXE")				
					try {
							_ref_N_EXE = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"N_EXE\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"N_EXE\".-->" << endl;
					}
				...
				if (name == "L_EXE")				
					try {
							_ref_L_EXE = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"L_EXE\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"L_EXE\".-->" << endl;
					}

					
				
				if (name == "START_VENTILATOR")				
					try {
							_ref_START_VENTILATOR = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"START_VENTILATOR\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"START_VENTILATOR\".-->" << endl;
					}

					
				
				if (name == "STOP_VENTILATOR")				
					try {
							_ref_STOP_VENTILATOR = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"STOP_VENTILATOR\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"STOP_VENTILATOR\".-->" << endl;
					}
				...
				if (name == "START_X_RAY")				
					try {
							_ref_START_X_RAY = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"START_X_RAY\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"START_X_RAY\".-->" << endl;
					}
				...
				if (name == "STOP_X_RAY")				
					try {
							_ref_STOP_X_RAY = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"STOP_X_RAY\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"STOP_X_RAY\".-->" << endl;
					}
				...
				if (name == "FAIL")				
					try {
							_ref_FAIL = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"FAIL\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"FAIL\".-->" << endl;
					}
				...
				if (name == "SUCCEED")				
					try {
							_ref_SUCCEED = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"SUCCEED\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"SUCCEED\".-->" << endl;
					}
				...
				if (name == "UNAVAILABLE")				
					try {
							_ref_UNAVAILABLE = stoi(value);
					} catch(std::invalid_argument e) {
						cout << "<!--Invalid value for variable \"UNAVAILABLE\".-->" << endl;
					} catch(std::out_of_range e) {
						cout << "<!--Value out of range for variable \"UNAVAILABLE\".-->" << endl;
					}
