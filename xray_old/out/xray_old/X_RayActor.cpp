...
, TIME_TYPE executionTime, TIME_TYPE deadline){
	...
	void X_RayActor::setNow(TIME_TYPE now) {
...

		{
			...
			(temp0=_ref_EI_X_RAY, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 223"), temp0)->_timed_msg_ack(myID, _ref_action, _ref_actionStatus, _ref_Lm, _ref_exeDelay + _ref_now, MAX_TIME);
		}
		if (__tNumber & 1) {
