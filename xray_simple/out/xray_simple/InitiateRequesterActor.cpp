	...
	void InitiateRequesterActor::setNow(TIME_TYPE now) {
...

		{
			...
			if (((_ref_passedTime<_ref_N_INI)&(!_ref_theFirsttime))) {
				{
					(temp0=_ref_s, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 99"), temp0)->_timed_msg_fastInitiateFailure(myID, _ref_action, (_ref_Lm+_ref_IR1Delay), _ref_now, MAX_TIME);
				}
}
			else {
				{
					startTimer(_ref_lastIni);
					(temp1=_ref_cs, assertion(temp1!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 104"), temp1)->_timed_msg_initiate(myID, _ref_action, (_ref_Lm+_ref_IR1Delay), _ref_invokerId, _ref_IR1Delay + _ref_now, MAX_TIME);
				}
}
			...
			if ((_ref_passedTime>=_ref_L_INI)) {
				{
					...
					(temp0=_ref_s, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 118"), temp0)->_timed_msg_timeOutFailure(myID, _ref_action, _ref_actionStatus, _ref_Lm, _ref_now, MAX_TIME);
				}
}
			else {
				if ((_ref_IR2Delay<_ref_L_INI)) {
					{
						(temp1=_ref_s, assertion(temp1!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 121"), temp1)->_timed_msg_ack(myID, _ref_action, _ref_actionStatus, _ref_Lm, _ref_IR2Delay + _ref_now, MAX_TIME);
					}
}}
		}
		if (__tNumber & 1) {
...

		{
			...
			(temp0=_ref_s, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 126"), temp0)->_timed_msg_excessLoadFailure(myID, _ref_action, _ref_Lm, _ref_now, MAX_TIME);
		}
		return 0;
...

		{
			...
			(temp0=_ref_s, assertion(temp0!= null, "Null Pointer Exception in method " + reactiveClassName + "." + methodName + "line 130"), temp0)->_timed_msg_timeOutFailure(myID, _ref_action, _ref_actionStatus, _ref_Lm, _ref_now, MAX_TIME);
		}
		return 0;
